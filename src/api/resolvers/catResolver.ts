...
import { Cat, CatInput, CatModify, LocationInput, TokenContent } from '../../types/DBTypes';
...
const catResolver = {
    ...
    Mutation: {
        ...
        updateCat: async (_parent: undefined, args: { id: string; input: Partial<Omit<Cat, 'id'>> }, context: MyContext,) => {
            isLoggedIn(context);
